...
export const requestApi = {
    user: {
        ...
        updateBySelf: (ref, params) => {return ref.$http.post(getApi(user, 'updateUserBySelf'), params)},
    ...
    store: {
        ...
        findOne: (ref, params) => {return ref.$http.post(getApi(store, 'findStoreItemByStoreItemId'), params)}
    ...
    buyOrder: {
        ...
        findByParamWithSelfId: (ref, params) => {return ref.$http.post(getApi(buy,'findBuyOrdersBySearchParamsWithSelfId'), params)},
