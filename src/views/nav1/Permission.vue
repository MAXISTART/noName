<template>
	<section>
		...
		<!--列表-->
		<el-table :data="permissions" border highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
			<el-table-column type="selection" width="55">
			</el-table-column>
			<el-table-column type="index" width="60" align="center">
			</el-table-column>
			<el-table-column label="权限信息" width="440" align="center">
				<el-table-column prop="name" label="名称" width="140" column-key="id" sortable align="center">
				</el-table-column>
				<el-table-column prop="description" label="权限描述" width="300" sortable align="center">
				</el-table-column>
			</el-table-column>
		...
		methods: {
			...
			handleDel: function (index, row) {
				this.$confirm('确认删除该记录吗?', '提示', {
					...
					//NProgress.start();
					let para = { id: row.id };
					requestApi.permission.delete(this, para).then(res => {
						//NProgress.done();
                        this.listLoading = false;
                        res = res.body;
                        if(res.code === Enum.SUCCESS.code) {
				...
				this.$refs.editForm.validate((valid) => {
					if (valid) {
						this.$confirm('确认提交吗？', '提示', {}).then(() => {
                            ...
                            requestApi.permission.update(this,para).then(res => {
			...
			batchRemove: function () {
				...
				this.$confirm('确认删除选中记录吗？', '提示', {
					...
					this.listLoading = true;
					//NProgress.start();
					requestApi.permission.deletes(this, els).then(res => {
                        this.listLoading = false;
                        //NProgress.done();
                        res = res.body;
                        if(res.code === Enum.SUCCESS.code) {
